        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="font-body text-white/70 text-sm leading-relaxed">
              Allt om fårullsisolering — naturlig, hållbar och effektiv isolering för ditt hem.
            </p>
            <a
              href="https://byeco.se"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block mt-6 bg-accent text-foreground px-6 py-2.5 rounded-soft text-sm font-medium hover:bg-accent/90 transition-colors"
            >
              Besök vår webshop
            </a>
          </div>
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-heading text-lg font-semibold mb-4">Sidor</h3>
